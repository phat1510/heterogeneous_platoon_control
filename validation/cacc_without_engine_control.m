...
% 2. In this test case, the control of engine is consider a open-loop. 
% The computed desired acceleration values are sent directly to the
% engine.
...
sim("cacc_without_engine_control_sim.slx")
...
% 1 vehicles
if strcmp(test_case,'case1')|strcmp(test_case,'case2')|strcmp(test_case,'case3')
subplot(221)
plot(sim_time, v_0, ...
    sim_time, v_1, ...
    LineWidth=lw); xlim([xlim_min xlim_max]); %ylim([-22 26])
