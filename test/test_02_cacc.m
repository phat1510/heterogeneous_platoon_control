...
% 2. CACC mode
% \dot{e}_i(t) &= v_{i-1}(t) - v_{i}(t) - \frac{h_i}{m_i} F_i(t)
% \dot{v}_i(t) &= \frac{1}{m_i} F_i(t)
% where m_i is the vehicle mass and F_i is the input longitudinal force
...
% K32 = tunableGain('K32',0); K32.u = 'y32'; K32.y = 'u32';
% K32.Gain.Free = 1;
% K32.Gain.Value = 0;
% K32.Gain.Minimum = -0.8;
% K32.Gain.Maximum = 0;
% K33 = tunableGain('K33',0); K33.u = 'y33'; K33.y = 'u33';
% 
% sum_u3 = sumblk('u3=u31+u32+u33');
...
if export_data
    ...
    fig_name = 'chap4_freq_v0_to_e_2PF.txt';
    ...
    % Vel
    fig_name = 'chap4_freq_v0_to_delta_v_2PF.txt'; % Create a new .txt file
    ...
    % Control input
    fig_name = 'chap4_freq_v0_to_u_2PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % String stability
    fig_name = 'chap4_freq_string_2PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % Get vel
    fig_name = 'chap4_time_vel_2pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s %s\n','t','v0','v1','v2','v3');
    fprintf(fileID,' %e %e %e %e %e\r\n',v_plot_ds);
    ...
    % Get error
    fig_name = 'chap4_time_err_2pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
