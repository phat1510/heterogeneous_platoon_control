...
%% Plants
h_leaf = 0.8; % not below than 0.4
h_prius = 1.2; % not below than 0.4

h = h_leaf;

A = [0 -1;0 0];
Bw = [1;0];
Bf1 = [-h_leaf;1]; B1 = [Bw Bf1];
Bf2 = [-h_prius;1]; B2 = [Bw Bf2];
Bf3 = [-h_leaf;1]; B3 = [Bw Bf3];
C = [1 0;0 1];
D = zeros(2,2);
...
Kv1.Gain.Free = 1;
Kv1.Gain.Value = 0;
Kv1.Gain.Minimum =  -1.01*1/h_leaf; Kv1.Gain.Maximum = -1/h_leaf;
...
if export_data
    ...
    fig_name = 'chap5_hete_freq_v0_to_e_2PF.txt';
    ...
    % Vel
    fig_name = 'chap5_hete_freq_v0_to_delta_v_2PF.txt'; % Create a new .txt file
    ...
    % Control input
    fig_name = 'chap5_hete_freq_v0_to_u_2PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % String stability
    fig_name = 'chap5_hete_freq_string_2PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    fclose(fileID);
     ...
     % Get accel
    fig_name = 'chap5_hete_time_acc_2pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % Get vel
    fig_name = 'chap5_hete_time_vel_2pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s %s\n','t','v0','v1','v2','v3');
    fprintf(fileID,' %e %e %e %e %e\r\n',v_plot_ds);
    ...
    % Get error
    fig_name = 'chap5_hete_time_err_2pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s\n','t','e1','e2','e3');
    fprintf(fileID,' %e %e %e %e\r\n',e_plot_ds);
