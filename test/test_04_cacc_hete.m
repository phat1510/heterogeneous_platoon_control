...
% Engine model for string stability check
...
if export_data
    ...
    fig_name = 'chap5_hete_freq_v0_to_e_PF.txt';
    ...
    % Vel
    fig_name = 'chap5_hete_freq_v0_to_delta_v_PF.txt'; % Create a new .txt file
    ...
    % Control input
    fig_name = 'chap5_hete_freq_v0_to_u_PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s %s\n','w','1/Wu','u1','u2','u3');
    fprintf(fileID,' %e %e %e %e %e\r\n',v0_to_u);
    ...
    % String stability
    fig_name = 'chap5_hete_freq_string_PF.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % Get accel
    fig_name = 'chap5_hete_time_acc_pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    ...
    % Get vel
    fig_name = 'chap5_hete_time_vel_pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s %s\n','t','v0','v1','v2','v3');
    fprintf(fileID,' %e %e %e %e %e\r\n',v_plot_ds);
    ...
    % Get error
    fig_name = 'chap5_hete_time_err_pf.txt';
    save(append(fig_loc, fig_name)); % Create a new .txt file
    fileID = fopen(append(fig_loc, fig_name),"w");
    fprintf(fileID,' %s %s %s %s\n','t','e1','e2','e3');
    fprintf(fileID,' %e %e %e %e\r\n',e_plot_ds);
