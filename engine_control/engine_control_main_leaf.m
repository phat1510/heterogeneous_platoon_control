% File name: engine_control_main_leaf.m
% Dependencies: 
...
[K_a, K_b] = get_controller(G_leaf_a_2nd, G_leaf_b_2nd);


%% Simulation

% Simulation variables
G_a = G_leaf_a; G_b = G_leaf_b;
G_a_2nd = G_leaf_a_2nd; G_b_2nd = G_leaf_b_2nd;
...
function [K_a,K_b] = get_controller(G_accel, G_decel)
    ...
    K_leaf_a = K_a;
    K_leaf_b = K_b;
    save('controllers/K_leaf.mat','K_leaf_a','K_leaf_b');
end
