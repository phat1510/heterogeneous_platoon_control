% File name: engine_control_main_camry.m
% Dependencies: 
...
[K_a, K_b] = find_controller(G_camry_a_2nd, G_camry_b_2nd);


%% Simulation

% Simulation variables
G_a = G_camry_a; G_b = G_camry_b;
G_a_2nd = G_camry_a_2nd; G_b_2nd = G_camry_b_2nd;
...
function [K_a,K_b] = find_controller(G_accel, G_decel)
    %% Controller design
    % For tracking error (S)
    Ms=2;wb=0.6;epsi=0.001;
    ...
    K_camry_a = K_a;
    K_camry_b = K_b;
    save('controllers/K_camry.mat','K_camry_a','K_camry_b');
end
